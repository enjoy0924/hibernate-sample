...
/**
 * Created by G_dragon on 2015/8/18.
 */
public class JedisClient {
    ...
    public void test1() {
        ...
        /** 连接redis */
        Jedis redis = new Jedis("192.168.213.128", 6379);
        ...
        List<String> multiKeyValue = redis.mget("haha", "xixi");
        for (int i = 0; i < multiKeyValue.size(); i++) {
            System.out.println(list.get(i));
        }
        ...
        List<String> hashMultiValue = redis.hmget("website", "google", "baidu", "sina");
        for (int i = 0; i < hashMultiValue.size(); i++) {
            System.out.println(list.get(i));
        }
    ...
    public static void main(String[] args) {
        JedisClient t1 = new JedisClient();
        t1.test1();
    }
